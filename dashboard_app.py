...
st.set_page_config(page_title="Northwind Sales OLAP_Chawanakorn673020247-7 Dashboard", layout="wide")
...
def main():
    st.title("Northwind Sales OLAP_Chawanakorn673020247-7 Dashboard")
